...
func TestCadvisorListPodStatsWhenContainerLogFound(t *testing.T) {
	...
	fakeStats := map[string]*volume.Metrics{
		kuberuntime.BuildContainerLogsDirectory(podLogsRootDirectory, prf0.Namespace, prf0.Name, types.UID(prf0.UID), cName00): containerLogStats0,
		kuberuntime.BuildContainerLogsDirectory(podLogsRootDirectory, prf0.Namespace, prf0.Name, types.UID(prf0.UID), cName01): containerLogStats1,
	}
